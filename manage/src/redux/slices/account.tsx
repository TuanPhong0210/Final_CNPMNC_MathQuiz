    ...
    createAccountSuccess: (state, action: PayloadAction<GeneralAccount>) => {
      ...
      switch (type) {
        case 'Administrator':
          ...
          break;
        case 'Teacher':
          state.teachers = [...state.teachers, account];
          break;
        case 'Student':
          state.students = [...state.students, account];
          break;
        default:
          break;
      }
      ...
      switch (type) {
        ...
        case 'Teacher':
          state.teachers = state.teachers.map((teacher) =>
            teacher._id === _id ? account : teacher
          );
          break;
        case 'Student':
          state.students = state.students.map((student) =>
            student._id === _id ? account : student
          );
          break;
        default:
          break;
